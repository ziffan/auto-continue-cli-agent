...
> resume/continue; R1–R3 + R4 slice 1 + R6/I-23 [deteksi limit CC primer + capture id CC, live-verified 2.1.207] ✅,
> sisa R4-slice2 + live-verify actuation inject/resume). 368 test hijau (2 skip POSIX-only
