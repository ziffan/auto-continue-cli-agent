...
Fase: **M5 — Hardening + Deploy sebagai service (SPEC LOCKED 17 Jul; implementasi mulai — M5.1 + M5.3 + M5.2 ✅ SANDBOX; M5.4 ✅ LIVE parsial [systemd --user: install+auto-restart+same-DB verified; reboot/logout residual]; M5.5 ⛔ DITUNDA/I-33).** **585 test hijau** (2 skip POSIX).
