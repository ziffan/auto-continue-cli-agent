# ISSUES — arsip writeup lengkap (s.d. 2026-07-18)

> Snapshot penuh `docs/ISSUES.md` sebelum pelangsingan 18 Jul (nol hard-delete). Semua writeup + `<details>` issue tertutup ada di sini; `docs/ISSUES.md` live hanya simpan Open + indeks. Greppable.
